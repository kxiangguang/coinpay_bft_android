package com.spark.modulebase.okhttp.store;
...
/**
 * Created by ${wuzongjie} on 2019/1/12.
 */
public class PersistentCookieStore implements CookieStore {
    ...
    public void add(URI uri, HttpCookie cookie) {
        ...
        if ("deleteMe".equals(cookie.getValue())) return;
...
//        if ((GlobalConstant.LowercaseSPOT + "sid").equals(cookie.getName())) {
//            SharedPreferenceInstance.getInstance().saveSID(cookie.getValue());
//        }
        /*if ("cfd-simulatesid".equals(cookie.getName())) {
            SharedPreferenceInstance.getInstance().saveSimulate(cookie.getValue());
        }*/
        LogUtils.i("保存的url===" + uri.toString() + ",,,,,保存的cookie==" + cookie.toString());
