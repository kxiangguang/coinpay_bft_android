...
import com.spark.coinpay.adapter.AppealFinishAdapter;
import com.spark.coinpay.base.BaseFragment;
import com.spark.coinpay.event.PsListFrushEvent;
import com.spark.coinpay.my.appeal.detail.AppealDetailFinishActivity;
 ...
 * 纠纷管理-已完成
 */
public class AppealFinishFragment extends BaseFragment implements AppealContract.AppealFinishView {
    ...
    private AppealFinishAdapter adapter;
    ...
    protected void initView(Bundle saveInstance) {
        ...
        adapter = new AppealFinishAdapter(R.layout.item_appeal, mDatas);
    ...
    protected void setListener() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                showActivity(AppealDetailFinishActivity.class, null, 1);
            }
        });
