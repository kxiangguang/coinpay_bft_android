...
import com.spark.coinpay.view.FilterPopView;
...
public class MyOrderActivity extends BaseActivity implements FilterPopView.FilterCallBack {
    ...
    protected void initView(Bundle saveInstance) {
        ...
        filterPopView = new FilterPopView(activity, this, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    }
    ...
    public void callBack(int type) {
        EventBus.getDefault().post(new OrderListFrushEvent(type));
    }
