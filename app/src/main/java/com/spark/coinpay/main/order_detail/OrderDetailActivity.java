...
import com.spark.coinpay.main.OrderActivity;
...
public class OrderDetailActivity extends OrderActivity implements OrderDetailContract.View {
        ...
        releaseDialog.setPositiveOnclickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.isEmpty(pwd)) {
                    ...
                    presenter.ensureOrderRelease(orderId, pwd);
     ...
     * @param event
     */
    public void onEvent(HasPayEvent event) {
        //设置倒计时
        mTimeHandler.removeCallbacks(runnable);
        setView();
    }
