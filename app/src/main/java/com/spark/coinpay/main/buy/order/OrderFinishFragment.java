 ...
 * 订单-已完成
 */
public class OrderFinishFragment extends BuyOrderFragment implements MyOrderContract.MyOrderView {
    ...
    protected void setListener() {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                PayEntity payEntity = new Gson().fromJson(new Gson().toJson(buyOrderEntity), new TypeToken<PayEntity>() {}.getType());
