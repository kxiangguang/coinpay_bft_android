...
public class PayActivity extends BaseActivity implements PayContract.PayView {
    ...
    private ConfirmPayDialog confirmDialog;
    ...
    private void showConfirmDialog() {
        confirmDialog = new ConfirmPayDialog(activity);
        confirmDialog.setPositiveOnclickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.isEmpty(pwd)) {
                    ...
                    presenter.payComplete(actualPayment, orderNo, pwd);
    ...
    private void showAlerDialog() {
        if (alertIosDialog == null) {
            ...
            alertIosDialog.setContent(getString(R.string.str_pay_success)).setTag(getString(R.string.str_pay_finish_tag));
    ...
    protected void setListener() {
        ...
        checkbox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    tvPayFinish.setEnabled(true);
                    tvPayFinish.setBackgroundResource(R.drawable.ripple_btn_global_option_corner_selector);
                    tvPayFinish.setTextColor(getResources().getColor(R.color.white));
                } else {
                    tvPayFinish.setEnabled(false);
                    tvPayFinish.setBackgroundResource(R.drawable.shape_bg_normal_corner_grey_enabled);
                    tvPayFinish.setTextColor(getResources().getColor(R.color.font_main_content));
                }
            }
        });
    }
