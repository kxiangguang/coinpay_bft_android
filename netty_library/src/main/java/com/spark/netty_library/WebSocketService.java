...
//                (host.contains("bench") ? "ws://192.168.2.183:38985/ws" : "ws://ws.bitaccept." + host + "/ws");
    ...
    private ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName componentName) {
            //断开链接
            startService(new Intent(WebSocketService.this, GuardService.class));
            //重新绑定
            bindService(new Intent(WebSocketService.this, GuardService.class), mServiceConnection, Context.BIND_IMPORTANT);
            //正在运行的service通知，type：1WebSocketService 2GuardService
            EventBus.getDefault().post(new ServiceTypeEvent(2));
        }
    };
     ...
     * 连接ws
     */
    public synchronized WebSocketService initSocket() {
        try {
